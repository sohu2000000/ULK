...
void blk_queue_bounce(request_queue_t *q, struct bio **bio_orig)
{
	 ...
	 * ¸ù¾İbounce_gfp±êÖ¾£¬Éè¶¨·ÖÅä³Ø(page_pool»òisa_page_pool)£¬Èç¹ûbounce_pfnÔÚ·ÇDMAÊ±´óÓÚblk_max_pfn£¬Ö±½Ó·µ»Ø
	 */
	 ...
	 */
	/*
	 * µ÷ÓÃ__blk_queue_bounce½øĞĞ·´µ¯ÇøµÄÕæÕı·ÖÅäºÍ³õÊ¼»¯
	 */

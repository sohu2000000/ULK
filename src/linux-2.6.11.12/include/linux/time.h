 ...
 */
/*setitimer 中指定采用的策略*/
#define	ITIMER_REAL	0		/*真正过去的时间，进程接受SIGALRM 信号*/
#define	ITIMER_VIRTUAL	1	/*进程在用户态花费的时间；进程接受SIGVTALRM 信号*/
#define	ITIMER_PROF	2		/*进程既在用户态下又在内核态下所花费的时间，进程接受SIGPROF 信号*/
...
/*间隔定时器设置的时间参数结构*/
struct	itimerval {
	/*定时器被自动重新激活后使用的持续时间(对于一次性定时器而言为0)*/
